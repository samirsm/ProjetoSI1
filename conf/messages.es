...
tela_login.subtitulo=Aventones de ida y retorno desde la UFCG
tela_login.listagem1=Notificaciones en tiempo real
tela_login.listagem2=Recomendaciones de conductores y passajeros
tela_login.listagem3=Usuarios registrados de confianza
tela_login.sucesso_cadastro=Registro realizado con éxito!
...
horarios.hora=Elige la hora
horarios.dia=Elige el día
horarios.bairro=Elige el barrio
horarios.novo_endereco=Registar nueva dirección
horarios.cadastre_endereco=Registra una nueva dirección
horarios.bairros=Barrios
horarios.rua=Escribe la calle:
horarios.cadastrar_endereco=Registrar
horarios.voltar=Volver a los horarios
horarios.cadastrados=Horarios registrados
...
view_usuario.oferecer=Ofrecer aventón
view_usuario.publicar=Publicar aquí tu aventón
view_usuario.buscar_aqui=Buscar aquí tu aventón
view_usuario.hora=Elige la hora
view_usuario.dia=Elige el día
view_usuario.bairro=Elige el barrio
view_usuario.publique=Publicar
...
agendamento.voltar=Volver a los Aventones
...
ajuda.texto1 =  O Vumbora foi criado para facilitar a vida dos estudantes e funcionários da UFCG. Além de promover a boa prática de formar amizades.
                  Nele você vai poder oferecer e solicitar caronas dada a sua localização e horário. Não é prático?
ajuda.texto2 = F.A.Q
...
ajuda.resposta4 = Assim que você se cadastrar sua tela será a de cadastrar seus horários de ida e vinda para oferecer e/ou buscar carona. Mas você pode
                  editar a qualquer momento clicando em "Horários" na barra lateral esquerda.
